					...
					<div className="space-y-2">
						...
						<Select value={paymentMethod} onValueChange={(v: PaymentMethod) => setPaymentMethod(v)}>
							...
							<SelectContent>
								...
								<SelectItem value="card_credit">Tarjeta de Credito</SelectItem>
								<SelectItem value="card_debit">Tarjeta de Debito</SelectItem>
						...
						<CardContent className="p-4">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-lg text-muted-foreground">${totalARS.toLocaleString()} ARS</p>
								</div>
