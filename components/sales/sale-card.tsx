...
export function SaleCard({ sale, onClick }: SaleCardProps) {
	...
	return (
		<Card className="cursor-pointer transition-all hover:bg-secondary/30" onClick={onClick}>
				...
				<div className="flex items-center justify-between">
					...
					<div className="flex items-center gap-3">
						<div className="text-right">
							<p className="text-lg font-bold text-foreground">${sale.totalUSD.toLocaleString()}</p>
							<p className="text-sm text-muted-foreground">${sale.totalARS.toLocaleString()} ARS</p>
						</div>
